...
var require_virtualscroll = __commonJS({
  "node_modules/virtual-scroll/lib/virtualscroll.js"(exports, module) {
    !function(e, t) {
      ...
      function i(e2, t2) {
        if (!Object.prototype.hasOwnProperty.call(e2, t2)) throw new TypeError("attempted to use private field on non-instance");
        return e2;
      }
      function n() {
      }
      n.prototype = { on: function(e2, t2, i2) {
        ...
        for (var t2 = [].slice.call(arguments, 1), i2 = ((this.e || (this.e = {}))[e2] || []).slice(), n2 = 0, o2 = i2.length; n2 < o2; n2++) i2[n2].fn.apply(i2[n2].ctx, t2);
        return this;
      }, off: function(e2, t2) {
        var i2 = this.e || (this.e = {}), n2 = i2[e2], o2 = [];
        if (n2 && t2) for (var s2 = 0, h2 = n2.length; s2 < h2; s2++) n2[s2].fn !== t2 && n2[s2].fn._ !== t2 && o2.push(n2[s2]);
      ...
      return function() {
        function e2(e3) {
          ...
          Object.defineProperty(this, r, { writable: true, value: void 0 }), Object.defineProperty(this, a, { writable: true, value: void 0 }), Object.defineProperty(this, l, { writable: true, value: void 0 }), Object.defineProperty(this, u, { writable: true, value: void 0 }), Object.defineProperty(this, c, { writable: true, value: void 0 }), Object.defineProperty(this, d, { writable: true, value: void 0 }), this._onWheel = function(e4) {
            ...
            o2.deltaX = e4.wheelDeltaX || -1 * e4.deltaX, o2.deltaY = e4.wheelDeltaY || -1 * e4.deltaY, s.isFirefox && 1 === e4.deltaMode && (o2.deltaX *= n2.firefoxMultiplier, o2.deltaY *= n2.firefoxMultiplier), o2.deltaX *= n2.mouseMultiplier, o2.deltaY *= n2.mouseMultiplier, t3._notify(e4);
        ...
        return t2._notify = function(e3) {
          ...
          var n2 = i(this, l)[l].e;
          n2 && n2[h] && 1 === n2[h].length && this._bind();
...
export default require_virtualscroll();
